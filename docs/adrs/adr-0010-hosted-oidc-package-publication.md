# ADR-0010: Hosted OIDC package publication
...
The previous `economy` release job selected self-hosted infrastructure and
...
`Plasius-LTD`, repository `economy`, workflow `cd.yml`, environment
