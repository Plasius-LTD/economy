...
export type LearningEntitlementId = string;
export type LearningModuleVersionId = string;
export type LotId = string;
export type ModuleAllowanceId = string;
export type ModuleSpendHoldId = string;
export type ModuleSpendQuoteId = string;
